		        ...
		        <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                             <a href="<?=ADMINURL?>profile-edit.php" class="btn btn-success btn-round">
						...
						<div class="form-group">
								   <label>Name </label>
								   <input type="text" class="form-control" name="admin_name" value=" <?=$_SESSION['ADMIN_ELALA_FULLNAME']?>" disabled />
								   <p> <?=$old_password_error;?></p>
							</div>
								
							 <div class="form-group">
									<label>Email Id</label>
									<input type="text" class="form-control" name="admin_email" value="<?=$_SESSION['ADMIN_ELALA_EMAIL']?>" disabled />
