...
<tr>
	<td>
			<table cellpadding="0" cellspacing="0" width="100%" border="0">
				<tr>
					<td style="padding-bottom:15px;"><img src="'.IMAGEURL.'logo.png" alt="'.SITETITLE.'" height="100" /></td>
				</tr>
			</table>
	...
	$subject = 'Admin Created New User on Elala!';
	...
	// Mail it
	mail('tarun@seawindsolution.com', $subject, $html, $headers);
